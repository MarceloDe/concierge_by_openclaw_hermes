...
export function fullOrchestrationStateSnapshot(state = {}) {
  ...
  return {
    ...
    // Phase 85: planner decision is the single classification authority (grouped v2
    // fields ONLY; the flat v1 aliases are removed). Summarized here; the full decision follows.
    llm_decision_classification: state.llm_orchestration_decision
      ? {
          ...
          intent: state.llm_orchestration_decision.classification?.intent ?? null,
